...
class GameController extends Controller
{
    private function getWordList($difficulty = 'medium')
    {
        $words = [
            'easy' => [
                'BROOD', 'KAARS', 'FRUIT', 'VLEES', 'APPEL',
                'PEPER', 'FIETS', 'TREIN', 'SCHIP', 'STEEN',
                'STOEL', 'PLANT', 'WATER', 'ZIJDE'
            ],
            'medium' => [
                'KAMER', 'RAMEN', 'TAFEL', 'VLOER', 'RAILS',
                'MARKT', 'ZOMER', 'LENTE', 'REGEN', 'EMAIL',
                'BODEM', 'SPOOR', 'WINKT', 'MUREN'
            ],
            'hard' => [
                'KABEL', 'BREIN', 'MODEL', 'TOREN', 'WAGEN',
                'KLOOF', 'ROEST', 'KADER', 'GLOED', 'GRAAF',
                'KUNST', 'KRANS', 'VLIES', 'STOOM', 'GEEST',
                'KNOOP', 'GLANS'
            ],
        ];
