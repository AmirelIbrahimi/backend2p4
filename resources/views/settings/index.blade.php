...
@section('content')
    <div class="max-w-2xl mx-auto">
        <h1 class="text-2xl font-bold mb-6 text-white">Instellingen</h1>

        <div class="space-y-6">
            <!-- Profile Settings -->
            <div class="bg-gray-900 rounded-lg shadow p-6">
                <h2 class="text-xl font-bold mb-4 text-white">Profiel</h2>
                <form method="POST" action="{{ route('settings.profile') }}" enctype="multipart/form-data">
                    @csrf
                    @method('PATCH')

                    <div class="mb-4">
                        <label class="block text-sm font-medium text-gray-300 mb-2">Gebruikersnaam</label>
                        <input type="text" name="username" value="{{ Auth::user()->username }}"
                               class="w-full px-3 py-2 border border-gray-600 bg-gray-800 text-white rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500">
                    </div>
            ...
            <!-- Game Settings -->
            <div class="bg-gray-900 rounded-lg shadow p-6">
                <h2 class="text-xl font-bold mb-4 text-white">Spel Instellingen</h2>
                <form method="POST" action="{{ route('settings.update') }}">
                    ...
                    <div class="mb-4">
                        <label class="block text-sm font-medium text-gray-300 mb-2">Moeilijkheidsgraad</label>
            ...
            <!-- Password Change -->
            <div class="bg-gray-900 rounded-lg shadow p-6">
                <h2 class="text-xl font-bold mb-4 text-white">Wachtwoord Wijzigen</h2>
