...
@section('content')
    <div class="max-w-2xl mx-auto">
        <div class="bg-gray-800 rounded-lg shadow p-6">
            <h1 class="text-2xl font-bold mb-6 text-blue-400">Nieuw Spel Starten</h1>
            ...
            <form method="POST" action="{{ route('games.store') }}">
                ...
                <div class="mb-6">
                    ...
                    <div class="space-y-3">
                        <label class="flex items-center p-3 border border-gray-600 rounded-lg cursor-pointer hover:bg-gray-700">
                            ...
                            <div>
                                <span class="font-medium text-gray-300">Willekeurige tegenstander</span>
                                <p class="text-sm text-gray-400">Speel tegen een willekeurige online speler</p>
                            </div>
                        </label>
                        ...
                        <label class="flex items-center p-3 border border-gray-600 rounded-lg cursor-pointer hover:bg-gray-700">
                            ...
                            <div>
                                <span class="font-medium text-gray-300">Vriend uitnodigen</span>
                                <p class="text-sm text-gray-400">Nodig een van je vrienden uit</p>
                            </div>
                        </label>
                    </div>
                </div>
                ...
                <div id="friend-select" class="mb-6 hidden">
                    <label for="friend_id" class="block text-sm font-medium text-gray-300 mb-2">
                        Selecteer een vriend
                    </label>
                    <select name="friend_id" id="friend_id" class="w-full px-3 py-2 border border-gray-600 bg-gray-700 text-white rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500">
                    ...
                    @if($friends->isEmpty())
                        <p class="text-sm text-gray-400 mt-1">
                            ...
                            <a href="{{ route('friends.index') }}" class="text-blue-400 hover:text-blue-300">
                                Voeg vrienden toe
                            </a>
                        </p>
                    @endif
