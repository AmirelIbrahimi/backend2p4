...
@section('content')
    <div class="max-w-6xl mx-auto">
        <div class="text-center mb-8">
            <h1 class="text-4xl font-bold text-blue-400 mb-4">Welkom bij Woordspel!</h1>
            <p class="text-lg text-gray-300">Daag je vrienden uit in dit leuke woordspel!</p>
        ...
        <div class="grid md:grid-cols-3 gap-6">
            <div class="bg-gray-800 rounded-lg shadow p-6">
                <h2 class="text-xl font-bold mb-4 text-blue-400">Top Spelers Vandaag</h2>
                @forelse($leaderboardToday as $index => $player)
                    <div class="flex items-center justify-between py-2 {{ $index === 0 ? 'text-yellow-400 font-bold' : 'text-gray-300' }}">
            ...
            <div class="bg-gray-800 rounded-lg shadow p-6">
                <h2 class="text-xl font-bold mb-4 text-blue-400">Top Spelers Deze Week</h2>
            ...
            <div class="bg-gray-800 rounded-lg shadow p-6">
                <h2 class="text-xl font-bold mb-4 text-blue-400">Alle Tijd Toppers</h2>
